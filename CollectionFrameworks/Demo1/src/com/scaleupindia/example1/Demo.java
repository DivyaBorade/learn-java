...
public class Demo {
	public static void main(String[] args) {
		...
		System.out.println("Find the size of List");
		System.out.println("Size of the list is:" + list.size());
		
		
		System.out.println("Display list");
		System.out.println("Contents of the list are:" + list);
		...
		System.out.println("Add element at given index of the list");
		list.add(1,"SQL");
		System.out.println("Size of the list is: "+list.size());
		System.out.println("Contents of the list are:" + list);
		...
		System.out.println("Sort element of list");
		Collections.sort(list);
		System.out.println("Elements of Sorted list are"+list);
